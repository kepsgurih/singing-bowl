	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
		...
		<div class="flex justify-between items-start mb-6 gap-4">
			...
			<button
				...
				class="bg-green-600 text-white px-4 py-2.5 rounded-lg hover:bg-green-700 shadow-sm transition-all duration-200 flex items-center gap-2 text-sm sm:text-base font-medium focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
			>
		...
		<div class="mb-6">
			<input
				...
				class="w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
			/>
		</div>
			...
			<div class="overflow-x-auto">
				<table class="min-w-full divide-y divide-gray-200">
					...
					<tbody class="bg-white divide-y divide-gray-200">
						{#each filteredSchedules as s}
							<tr
								class="transition-colors {s.disable
									? 'opacity-50 bg-red-400 text-white'
