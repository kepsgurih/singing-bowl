    ...
    <form method="POST" class="space-y-6">
        <div>
          ...
          <div>
            ...
            <input id="time" name="time" type="time" bind:value={data.calendar.time} class="w-full p-3 border rounded-lg" required />
          </div>
          
          <div>
            <label for="kelas" class="block mb-2 text-sm font-medium">Location</label>
            <input id="kelas" name="kelas" type="text" bind:value={data.calendar.kelas} class="w-full p-3 border rounded-lg" required />
          </div>
          
          <div>
            <label for="status" class="block mb-2 text-sm font-medium">Status</label>
            <select id="status" name="status" bind:value={data.calendar.status} class="w-full p-3 border rounded-lg">
          ...
          <div>
            ...
            <select id="scheduleId" name="scheduleId" bind:value={data.calendar.scheduleId} class="w-full p-3 border rounded-lg" required>
