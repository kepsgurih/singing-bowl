...
<div class="w-full px-4 sm:px-6 md:px-8 py-8">
	<div
		class="bg-gradient-to-b from-white to-gray-50 rounded-3xl shadow-lg p-6 sm:p-8 md:w-4/5 lg:w-3/5 mx-auto"
	>
		<h2 class="text-2xl sm:text-3xl font-semibold text-gray-800 mb-6 sm:mb-8 text-center">
			Config Settings
		</h2>
		...
		<form method="POST" enctype="multipart/form-data" class="space-y-5 sm:space-y-6">
			...
			<div class="form-group">
				...
				<div class="flex items-center space-x-4">
					...
					<div class="flex-1">
						<label
							class="relative flex items-center justify-center w-full p-3 border-2 border-dashed border-gray-300 rounded-xl hover:border-blue-400 bg-gray-50 cursor-pointer transition-all"
						>
							<input
								type="file"
								name="file"
			...
			<div class="form-group">
				...
				<textarea id="description" name="description" value={descriptionText}
				></textarea>
			</div>
